...
/** Tests the self-consistency of the forward/jacobian/jacobianAdjoint functions of the divide-constant operator.
  *
  * @author Dick Carter
  */
class DivideConstantSpec extends UnitSpec with ComputeTests {
  ...
  "The divide-constant operator" should "support positive scales" in {
  ...
  it should "throw an exception for zero scales" in {
    val inputShapes = Seq(Shape(24, 22))
    def fn = closure(0f)
