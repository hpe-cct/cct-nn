...
/** Tests the self-consistency of the forward/jacobian/jacobianAdjoint functions of the Tanh operator.
  *
  * @author Matthew Pickett and Ben Chandler
  */
class TanhSpec extends UnitSpec with ComputeTests {
  val fn = {
    (s: Seq[DifferentiableField]) => Tanh(s.head)
  }

  "The Tanh operator" should "support 0D input" in {
